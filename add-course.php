...
if(isset($_POST['add_course'])){
   ...
   $sql = " INSERT INTO `tbl_course`( `cshort`, `cfull`, `cdate`) VALUES ('$cshot','$cfull','$cdate') ";
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-4">
                                            <input name="cshot" type="text" class="form-control" id="inputPassword" placeholder="ex@ M.C.A" required>
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-2 col-form-label">Course Full Name*</label>
                                            <div class="col-sm-4">
                                              <input name="cfull" type="text" class="form-control" id="inputPassword" placeholder="ex@ Master of xyz" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-2 col-form-label">Creation Date</label>
                                            <div class="col-sm-4">
                                                <input name="cdate" id="date" name="date" class="form-control">
                                            </div>
                                          </div>
                                          <br>
                                          <button type="submit" class="btn btn-danger " name="add_course">Create Course</button>
