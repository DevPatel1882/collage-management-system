                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    include 'connection.php';
                                    $sql = " SELECT * FROM student INNER JOIN tbl_course ON student.cshort_id = tbl_course.cid where sid=sid " ;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="update_student.php?sid=<?php echo $res['sid']; ?>"  class="edit" ><i style="color:orange" class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;&nbsp;</i></a>
								                <a href="delete_student.php?sid=<?php echo $res['sid']; ?>" class="delete"><i style="color: red;" class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;&nbsp;</i></a>
                                            </td>
                                        </tr>
