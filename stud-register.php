...
$sql = "INSERT INTO `student`(`enroll_no`,`first_name`, `last_name`, `birthdate`, `gender`, `nationality`, `category`, `Family_Income`, `Mobile_Number`, `Email_Id`, `Permanent_Address`, `Correspondence_Address`, `country_id`, `state_id`, `city`, `cshort_id`, `subject`) VALUES ('$enroll_no','$first_name','$last_name','$birthdate','$gender','$nationality','$category','$Family_Income','$Mobile_Number','$Email_Id','$Permanent_Address','$Correspondence_Address','$country_id','$state_id','$city','$cshort_id','$subject') ";
                                        ...
                                        ?> 
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                              ...
                                              <input  name="subject"  id="c-full" type="text" class="form-control"  placeholder="" required>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                              ...
                                              <input  name="enroll_no"  id="enroll_no" type="text" class="form-control"  placeholder="" required>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="wrapper rounded bg-white">
                                        ...
                                        <div class="form">
                                            <div class="row">
                                                <div class="col-md-6 mt-md-0 mt-3"> <label>First Name</label> <input name="first_name" type="text" class="form-control" required style="width: 500px;"> </div>
                                                <div class="col-md-6 mt-md-0 mt-3"> <label>Last Name</label> <input name="last_name" type="text" class="form-control" required style="width: 500px;"> </div>
                                            </div>
                                            <div class="row">
                                                
                                                <div class="col-md-6 mt-md-0 mt-3"><br> <label>Birthday</label> <input name="birthdate" type="date" class="form-control" required style="width: 500px;"> </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mt-md-0 mt-3"><br> <label>Nationality</label> <input name="nationality" type="text" class="form-control" required style="width: 500px;"> </div>
                           ...
                           <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="wrapper rounded bg-white">
                                    ...
                                    <div class="form">
                                        <div class="row">
                                            <div class="col-md-6 mt-md-0 mt-3"> <label>Mobile Number</label> <input name="Mobile_Number" type="text" class="form-control" required style="width: 500px;"> </div>
                                            <div class="col-md-6 mt-md-0 mt-3"> <label>Email Id</label> <input name="Email_Id" type="text" class="form-control" required style="width: 500px;"> </div>
                                        </div>
                                        <div class="row">
                                            
                                            <div class="col-md-6 mt-md-0 mt-3"><br> <label>Permanent Address<br></label> <textarea name="Permanent_Address" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea> </div>
                                            <div class="col-md-6 mt-md-0 mt-3"><br> <label>Correspondence Address</label>
                                                <div class="d-flex align-items-center mt-2"> <label class="option"> <textarea name="Correspondence_Address" class="form-control" id="exampleFormControlTextarea1" rows="3" style="width: 500px;"></textarea> </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                      ...
                                      <br>
                                      <button name="stud" type="submit" class="btn btn-danger">Submit</button>
