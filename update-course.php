...
if(isset($_POST['update'])){
    ...
    $q = " UPDATE `tbl_course` SET `cid`= $cid,`cshort`='$cshort',`cfull`='$cfull',`updated_date`='$updated_date' WHERE cid = $cid  ";
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <?php
                                       ...
                                       $rec_course = mysqli_fetch_array($query)
                                   ?>
                                    <form method="post">
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-4">
                                            ...
                                            <input value="<?php echo $rec_course['cshort']; ?>" name="cshort" type="text" class="form-control" id="inputPassword" placeholder="ex@ M.C.A" required>
                                          </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPassword" class="col-sm-2 col-form-label">Course Full Name*</label>
                                            <div class="col-sm-4">
                                              <input value="<?php echo $rec_course['cfull']; ?>" name="cfull" type="text" class="form-control" id="inputPassword" placeholder="ex@ Master of xyz" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                          ...
                                          <br>
                                          <button type="submit" class="btn btn-danger " name="update">Update Course</button>
