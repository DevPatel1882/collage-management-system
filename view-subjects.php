                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="width:80px;">
                                                <a href="update-subject.php?subid=<?php echo $res['subid']; ?>"  class="edit" ><i style="color:orange" class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;&nbsp;</i></a>
								                <a href="delete.php?subid=<?php echo $res['subid']; ?>" class="delete"><i style="color: red;" class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;&nbsp;</i></a>
                                            </td>
                                        </tr>
                                    <?php
                                       }
